...
const translations = {
  en: {
    ...
    // Hero
    'hero.relationship.title': 'Sacred Bonds &',
    'hero.relationship.title.highlight': 'Eternal Love',
    'hero.relationship.subtitle': 'Navigate the sacred path of love and marriage with ancient Vedic wisdom.',
    'hero.career.title': 'Destiny &',
    'hero.career.title.highlight': 'Financial Abundance',
    'hero.career.subtitle': 'Unlock the celestial gates for professional success and eternal prosperity.',
    'hero.health.title': 'Vitality &',
    'hero.health.title.highlight': 'Inner Harmony',
    'hero.health.subtitle': 'Balance your energies and achieve holistic well-being through ancient traditions.',
    'hero.vastu.title': 'Auspicious Living &',
    'hero.vastu.title.highlight': 'Prosperous Spaces',
    'hero.vastu.subtitle': 'Invoke positive vibrations in your home and secure your future prosperity.',
    'hero.business.title': 'Business Growth &',
    'hero.business.title.highlight': 'Strategic Success',
    'hero.business.subtitle': 'Scale your ventures with cosmic insights and astro-strategic guidance.',
    'hero.matchmaking.title': 'Celestial Union &',
    'hero.matchmaking.title.highlight': 'Perfect Harmony',
    'hero.matchmaking.subtitle': 'Ensuring a lifetime of joy through deep celestial compatibility.',
    'hero.matrimonial.title': 'Divine Match &',
    'hero.matrimonial.title.highlight': 'Soulmate Discovery',
    'hero.matrimonial.subtitle': 'Find your ideal life partner through the lens of cosmic alignment.',
  ...
  hi: {
    ...
    'hero.relationship.subtitle': 'प्रेम और विवाह के पावन मार्ग को प्राचीन वैदिक सिद्धि से आलोकित करें।',
    'hero.career.title': 'भाग्य और उन्नति -',
    'hero.career.title.highlight': 'करियर और धन लाभ',
    'hero.career.subtitle': 'व्यावसायिक सफलता और अखंड समृद्धि के लिए शुभ योगों को अनलॉक करें।',
    'hero.health.title': 'काया कल्प और',
    'hero.health.title.highlight': 'मानसिक शांति',
    'hero.health.subtitle': 'वैदिक ज्ञान के माध्यम से अपने प्राणों को संतुलित करें और पूर्ण स्वास्थ्य पाएं।',
    'hero.vastu.title': 'शुभ वास्तु और',
    'hero.vastu.title.highlight': 'संपत्ति लाभ',
    'hero.vastu.subtitle': 'अपने निवास में दैवीय ऊर्जा का आह्वान करें और सुख-समृद्धि पाएं।',
    'hero.business.title': 'व्यापार वृद्धि और',
    'hero.business.title.highlight': 'सिद्धि प्राप्ति',
    'hero.business.subtitle': 'बाधाओं को दूर करें और ज्योतिषीय रणनीति से अपने व्यवसाय को नई ऊंचाई दें।',
    'hero.matchmaking.title': 'गुण मिलान और',
    'hero.matchmaking.title.highlight': 'अष्टकूट मिलान',
    'hero.matchmaking.subtitle': 'गहरी कुंडली अनुकूलता के माध्यम से जीवनभर के सामंजस्य को सुनिश्चित करें।',
    'hero.matrimonial.title': 'श्रेष्ठ मिलान और',
    'hero.matrimonial.title.highlight': 'जीवनसाथी की खोज',
    'hero.matrimonial.subtitle': 'ब्रह्मांडीय संरेखण और संस्कारों के आधार पर अपने आदर्श जीवनसाथी को खोजें।',
