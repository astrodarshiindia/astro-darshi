...
const translations = {
  en: {
    ...
    'hero.relationship.subtitle': 'Master the karmic flow of love and marriage through ancient Vedic Siddhi.',
    'hero.career.title': 'Karmic Path &',
    'hero.career.title.highlight': 'Professional Success',
    'hero.career.subtitle': 'Unlock your Shubh Yog for career growth and material abundance.',
    'hero.health.title': 'Pranic Balance &',
    'hero.health.title.highlight': 'Holistic Healing',
    'hero.health.subtitle': 'Align your Chakras and Prana for supreme health and mental peace.',
    'hero.vastu.title': 'Vastu Shastra &',
    'hero.vastu.title.highlight': 'Divine Abode',
    'hero.vastu.subtitle': 'Invoke Vastu energies to transform your home into a sanctuary of prosperity.',
    'hero.business.title': 'Business Siddhi &',
    'hero.business.title.highlight': 'Wealth Growth',
    'hero.business.subtitle': 'Scale your business with Astro-strategic wisdom and planetary alignment.',
    'hero.matchmaking.title': 'Kundli Alignment &',
    'hero.matchmaking.title.highlight': 'Ashta-Koot Harmony',
    'hero.matchmaking.subtitle': 'Ensure lifelong harmony through deep Ashta-Koot Kundli compatibility.',
    'hero.matrimonial.title': 'Divine Soulmates &',
    'hero.matrimonial.title.highlight': 'Vedic Matching',
    'hero.matrimonial.subtitle': 'Find your soulmate through the filter of Guna matching and cosmic values.',
