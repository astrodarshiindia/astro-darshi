...
const translations = {
  en: {
    ...
    // Hero
    'hero.relationship.title': 'Pavitra Bandhan &',
    'hero.relationship.title.highlight': 'Sukhad Vivah',
    'hero.relationship.subtitle': 'Navigate the sacred path of love and marriage with ancient Vedic Siddhi.',
    'hero.career.title': 'Bhagya & Unnati in',
    'hero.career.title.highlight': 'Career & Wealth',
    'hero.career.subtitle': 'Unlock the Shubh Yog for professional success and eternal prosperity.',
    'hero.health.title': 'Kaya Kalp &',
    'hero.health.title.highlight': 'Mansik Shanti',
    'hero.health.subtitle': 'Balance your Prana and achieve holistic well-being through Vedic wisdom.',
    'hero.vastu.title': 'Shubh Vastu &',
    'hero.vastu.title.highlight': 'Property Labh',
    'hero.vastu.subtitle': 'Invoke divine energy in your Abode and secure your ancestral property.',
    'hero.business.title': 'Vyapar Vriddhi &',
    'hero.business.title.highlight': 'Siddhi Prapti',
    'hero.business.subtitle': 'Overcome hurdles and scale your business with Astro-strategic guidance.',
    'hero.matchmaking.title': 'Gun Milan &',
    'hero.matchmaking.title.highlight': 'Ashta-Koot Milan',
    'hero.matchmaking.subtitle': 'Ensuring a lifetime of harmony through deep Kundli compatibility.',
    'hero.matrimonial.title': 'Auspicious Match &',
    'hero.matrimonial.title.highlight': 'Jeevansathi Khoj',
    'hero.matrimonial.subtitle': 'Find your soulmate through the filter of cosmic alignment and values.',
