      ...
      content={
        <div className="space-y-12">
          ...
          <section className="space-y-6 bg-card/50 p-8 md:p-12 rounded-[2rem] border border-border/50">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              At Astro Paramarsh, we provide personalized consultations that address your unique concerns, from career and wealth to relationships and spiritual growth. Our methods are rooted in Parasara and Jaimini systems, ensuring the highest level of accuracy.
            </p>
